                        ...
                        <div class="glass-panel p-4 rounded-xl border border-slate-900 flex flex-col gap-4">
                            ...
                            <div class="flex flex-col gap-2 font-mono text-[10px]">
                                ...
                                <div class="flex flex-col gap-1.5">
                                    ...
                                    <select id="layout-edit-mode" onchange="toggleLayoutCalibratorMode(this.value)" class="w-full bg-slate-950 border border-slate-800 rounded py-1.5 px-3 outline-none text-slate-300">
